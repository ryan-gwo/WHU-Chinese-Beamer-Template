...
WHU风格改编由\hrefcol{https://github.com/ryan-gwo/WHU-Chinese-Beamer-Template}{Yuze (Ryan) Guo}贡献
...
\item 如果你有修改或建议，\hrefcol{https://github.com/ryan-gwo/WHU-Chinese-Beamer-Template/issues}{欢迎提交 Issue！}
\end{itemize}
\end{frame}
